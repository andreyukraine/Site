					...
					foreach ($arResult["GRID"]["HEADERS"] as $id => $arColumn):
						...
						?>
							<td class="price right">
								<div class="current_price"><? echo $arItem["PRICE_FORMATED"]; ?></div>
			...
			<table class="bx_ordercart_order_sum">
				<tbody>
					...
					<tr>
						...
						<td class="custom_t2" class="price"><? echo $arResult["ORDER_PRICE_FORMATED"]; ?></td>
					</tr>
					<?
					...
					if (doubleval($arResult["DELIVERY_PRICE"]) > 0)
					{
						...
						<tr>
							...
							<td class="custom_t2" class="price"><? echo CCurrencyLang::CurrencyFormat(site::convertPrice($arResult["DELIVERY_PRICE"]), site::getCurrency(), true); ?></td>
						</tr>
						<?
					}
					...
					?>
						<tr>
							...
							<td class="custom_t2 fwb" class="price"><? echo $arResult["ORDER_TOTAL_PRICE_FORMATED"]; ?></td>
						</tr>
						<tr>
