							...
							<label for="ID_DELIVERY_<?=$delivery_id?>_<?=$profile_id?>">
								...
								<div class="bx_description">
									...
									<span class="bx_result_price"><!-- click on this should not cause form submit -->
										...
										?>
											<div><?=GetMessage("SALE_DELIV_PRICE")?>:&nbsp;<b><?=CCurrencyLang::CurrencyFormat($arResult["DELIVERY_PRICE"], site::getCurrency(), true)?></b></div>
										<?
											...
											$APPLICATION->IncludeComponent('bitrix:sale.ajax.delivery.calculator', '', array(
												...
												"ORDER_PRICE" => site::convertPrice($arResult["ORDER_PRICE"]),
							...
							<label for="ID_DELIVERY_ID_<?=$arDelivery["ID"]?>" <?=$clickHandler?>>
								...
								<div class="bx_description">
									...
									<span class="bx_result_price">
										...
										?>
										<?=GetMessage("SALE_DELIV_PRICE");?>: <b><?=site::convertPrice($arDelivery["PRICE_FORMATED"]);?></b><br />
									</span>
									<p>
										<?
