...
?> class="reviews-form">
	...
	<div style="position:relative; display: block; width:100%;">
			...
			<div class="reviews-reply-fields">
				<div class="reviews-reply-field-user">
					<div class="reviews-reply-field reviews-reply-field-author">
						<span><input name="REVIEW_AUTHOR" id="REVIEW_AUTHOR<?=$arParams["form_index"]?>" placeholder="<?=GetMessage("OPINIONS_NAME")?>" size="30" type="text" value="<?=$arResult["REVIEW_AUTHOR"]?>" tabindex="<?=$tabIndex++;?>" /></span>
					</div>
					<?
					if ($arResult["FORUM"]["ASK_GUEST_EMAIL"]=="Y"):
						?>
						<div class="reviews-reply-field reviews-reply-field-email">
							<span><input type="text" name="REVIEW_EMAIL" id="REVIEW_EMAIL<?=$arParams["form_index"]?>" placeholder="<?=GetMessage("OPINIONS_EMAIL")?>" size="30" value="<?=$arResult["REVIEW_EMAIL"]?>" tabindex="<?=$tabIndex++;?>" /></span>
						</div>
					<?
					endif;
					?>
		...
		?>
		<div class="reviews-reply-buttons author_page_input_capcha_send_block">
			<input name="send_button" type="submit" class="author_page_button sprite_review_active" value=" " tabindex="<?=$tabIndex++;?>" <?
