...
?>
<table class="order_page_inputs" style="border: none">
	<tbody>
...
if ($arResult["USE_CAPTCHA"] == "Y")
{
	?>
		...
		<tr>
			<td><div class="author_page_capcha_info">Введите символы, изображенные на рисунке:</div></td>
			<td>
				<input type="hidden" name="captcha_sid" value="<?=$arResult["CAPTCHA_CODE"]?>" />
				<img src="/bitrix/tools/captcha.php?captcha_sid=<?=$arResult["CAPTCHA_CODE"]?>" width="180" height="40" alt="CAPTCHA" class="new_captcha_image" />
				<input type="text" name="captcha_word" class="new_captcha_text" maxlength="50" value="" />
			</td>
		</tr>
	<?
}
...
?>
	...
	<div class="registration_page_buttons">
		<input type="submit" name="register_submit_button" value=" " class="registration_page_registration_button" />
		<a href="/login"><div class="registration_page_autorization_button"></div></a>
	</div>
</form>
<?endif?>
</div>