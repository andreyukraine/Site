					...
					<tr id="<?=$arItem["ID"]?>">
								...
								<td class="itemphoto">
									<div class="bx_ordercart_photo_container">
										...
										<?if (strlen($arItem["DETAIL_PAGE_URL"]) > 0):?><a href="<?=$arItem["DETAIL_PAGE_URL"] ?>"><?endif;?>
											<div class="bx_ordercart_photo 1" style="background-image:url('<?=$image['src']?>')"></div>
										...
										<table cellspacing="0" cellpadding="0" class="counter">
											<tr>
                                                ...
                                                <?php if ($bDeleteColumn) { ?>
                                                    <td>
                                                        <a class="basket-remove-button" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delete"])?>"></a>
                                                    </td>
                                                <?php } ?>
						...
						?>
							<td class="control">
								...
								if ($bDelayColumn):
								?>
									<a class="basket-delay-button" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delay"])?>"><?=GetMessage("SALE_DELAY")?></a>
								<?
								endif;
								?>
							</td>
					...
					foreach ($arResult['COUPON_LIST'] as $oneCoupon)
					{
						...
						<div class="bx_ordercart_coupon">
							...
							<div class="bx_ordercart_coupon_notes">
								<? if (isset($oneCoupon['CHECK_CODE_TEXT'])) echo (is_array($oneCoupon['CHECK_CODE_TEXT']) ?
