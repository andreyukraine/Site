	...
	else
	{
		...
		function ShowComment($comment, $tabCount=0, $tabSize=2.5, $canModerate=false, $User=Array(), $use_captcha=false, $bCanUserComment=false, $errorComment=false, $arParams = array())
		{
			...
			if($comment["SHOW_AS_HIDDEN"] == "Y" || $comment["PUBLISH_STATUS"] == BLOG_PUBLISH_STATUS_PUBLISH || $comment["SHOW_SCREENNED"] == "Y" || $comment["ID"] == "preview")
			{
				...
				?>
				<a name="<?=$comment["ID"]?>"></a>
				<div class="blog-comment tab-body-container-review" style="padding-left:<?=$paddingSize?>em; <? if($paddingSize > 0) { echo 'border-top: none'; } ?>">
							...
							<form method="POST" name="form_comment" id="form_comment" action="<?= $ajaxPath; ?>">
								...
								if (isset($_REQUEST["IBLOCK_ID"])) {
									?><input type="hidden" name="IBLOCK_ID"
											 value="<?= (int)$_REQUEST["IBLOCK_ID"]; ?>"><?
								}
								if (isset($_REQUEST["ELEMENT_ID"])) {
									?><input type="hidden" name="ELEMENT_ID"
											 value="<?= (int)$_REQUEST["ELEMENT_ID"]; ?>"><?
								}
								...
								<div class="blog-comment-fields">
										...
										<div class="blog-comment-field blog-comment-field-user">
											<div class="blog-comment-field blog-comment-field-author">
												...
												<span><input maxlength="255" size="30" tabindex="3" type="text"
															 ...
															 value="<?= htmlspecialcharsEx($_SESSION["blog_user_name"]) ?>" placeholder="Имя:"></span>
											</div>
											...
											<div class="blog-comment-field blog-comment-field-email">
												...
												<span><input maxlength="255" size="30" tabindex="4" type="text"
															 ...
															 value="<?= htmlspecialcharsEx($_SESSION["blog_user_email"]) ?>" placeholder="Email:"></span>
											</div>
											<div class="blog-clear-float"></div>
										</div>
										<?
									...
									<? if ($arParams["NOT_USE_COMMENT_TITLE"] != "Y") {
										...
										<div class="blog-comment-field blog-comment-field-title">
											<div class="blog-comment-field">
												...
												<span><input size="70" type="text" name="subject" id="subject" value="" placeholder="Имя:"></span>
												<div class="blog-clear-float"></div>
											</div>
										</div>
										<?
									...
									if ($arResult["use_captcha"] === true) {
										...
										<div class="blog-comment-field blog-comment-field-captcha">
											<div class="blog-comment-field-captcha-label">
												...
												<input type="text" size="30" name="captcha_word" id="captcha_word"
													   value="" tabindex="7">
											</div>
													...
													<? if ($arResult["use_captcha"] === true) {
														...
														<div id="captcha_del">
															<img
																...
																width="180" height="40" id="captcha">
															<script>
									...
									<div class="blog-comment-buttons">
										<input tabindex="10" value="<?/*= GetMessage("B_B_MS_SEND") */?>" class="blog-comment-submit-button" type="button" name="sub-post" id="post-button" onclick="submitComment()">
									</div>
								</div>
