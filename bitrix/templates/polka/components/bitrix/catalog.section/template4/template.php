...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	?>
	<div class="item_box news_section col-xs-6">
		<div>
		...
		<div class="col-xs-6 price_block no-padding">
			...
			<div class="autor"><?php echo $arItem['PROPERTIES']['AUTOR']['VALUE']; ?></div>
				...
				<div id="<? echo $arItemIDs['PRICE']; ?>" class="bx_price">
					<?
						if(!empty($arItem['PROPERTIES']['PRICE_OLD']['VALUE']) && $arItem['PROPERTIES']['PRICE_OLD']['VALUE'] != '0.00') { ?>
							<s class="price-old"><?php echo CCurrencyLang::CurrencyFormat(site::ConvertPrice($arItem['PROPERTIES']['PRICE_OLD']['VALUE']), site::getCurrency(),true); ?></s>
						 <? }
						if (!empty($arItem['MIN_PRICE']))
						{
							...
							{
								?> <span><? echo CCurrencyLang::CurrencyFormat(site::ConvertPrice($arItem['MIN_PRICE']['PRINT_VALUE']), site::GetCurrency(), true); ?></span><?
							}
						}
						?>
				</div>
