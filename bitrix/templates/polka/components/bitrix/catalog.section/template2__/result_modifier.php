...
if (!empty($arResult['ITEMS']))
{
	...
	{
		if(!empty($arItem['PROPERTIES']['AUTHOR_XMLID']['VALUE'])) {
			$arItem['PROPERTIES']['AUTHOR_XMLID']['VALUE_ELEMENTS'] = array();
			$db_v = CIBlockElement::GetList(array(), array('IBLOCK_ID'=>7, 'XML_ID'=>$arItem['PROPERTIES']['AUTHOR_XMLID']['VALUE']), false, false, array('*', 'DETAIL_PAGE_URL'));
			while($v = $db_v->GetNext()) $arItem['PROPERTIES']['AUTHOR_XMLID']['VALUE_ELEMENTS'][] = $v;
		}
