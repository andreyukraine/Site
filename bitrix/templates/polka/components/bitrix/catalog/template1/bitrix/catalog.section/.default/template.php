...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	// if(!empty($arItem['MIN_BASIS_PRICE']['ORIG_CURRENCY'])) {
		$arItem['MIN_BASIS_PRICE']['ORIG_CURRENCY'] = 'USD';
		// $arItem['ORIG_CURRENCY']['ORIG_CURRENCY'] = (@$_COOKIE['currency']?$_COOKIE['currency']:'UAH');
	// }
	$productTitle = (
	...
	<?if(!empty($arItem['PROPERTIES']['PRICE_OLD']['VALUE'])) { ?> <s class="price-old"><?php echo $arItem['PROPERTIES']['PRICE_OLD']['VALUE']; ?></s> <?}?>
	<?
...
<?
		...
		// echo $arItem['ORIG_CURRENCY']['ORIG_CURRENCY'];
		$arJSParams = array(
