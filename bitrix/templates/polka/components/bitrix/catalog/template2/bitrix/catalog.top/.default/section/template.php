...
?>
	<div class="<? echo ($arItem['SECOND_PICT'] ? '' : 'bx_catalog_item'); ?>"><div class="" id="<? echo $strMainID; ?>">
		<div class="bx_catalog_item_title blog_post_item_header">
			<a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" title="<? echo $productTitle; ?>"><? echo $productTitle; ?></a></div>
			<a id="<? echo $arItemIDs['PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="bx_catalog_item_images blog_post_item_content_photo" style="background-image: url(<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>)" title="<? echo $imgTitle; ?>">
