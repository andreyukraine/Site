...
?>
<div id="top_custom_section_<?=$arParams['CUSTOM_SECTION_ID']?>" class="top_custom_section">
...
?>
	<?
	$rootSection = CIBlockSection::GetNavChain(2, $arItem['IBLOCK_SECTION_ID'])->GetNext();
	$rootSection = $rootSection['ID'];
	?>
	<div class="<? echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>"><div class="bx_catalog_item_container" id="<? echo $strMainID; ?>">
		<a id="<? echo $arItemIDs['PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="bx_catalog_item_images <? if($rootSection == 101) { echo 'bx_catalog_top_ebook'; } ?>" style="background-image: url(<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>)" title="<? echo $imgTitle; ?>">
			<? if($rootSection == 101) { ?>
