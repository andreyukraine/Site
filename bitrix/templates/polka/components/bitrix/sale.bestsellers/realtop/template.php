...
//	'TEMPLATE_THEME' => $this->GetFolder() . $arParams['TEMPLATE_THEME'] . '/owl.carousel.css',
...
?>
<div class="top_custom_section" id="top_custom_section_<? echo($arParams['SECTION_ID']); ?>">
	<!-- <div class="bx_item_list_title"><? echo GetMessage('SB_HREF_TITLE') ?>:</div> -->
	<div class="slider_real_top_wrap bx_catalog_tile_home_type_2 col<? echo $arParams['LINE_ELEMENT_COUNT']; ?> <? echo $templateData['TEMPLATE_CLASS']; ?>">
        ...
        <div class="slider_real_top bx_catalog_tile_slide owl-carousel">
			...
			{
				// кастомный костыль делим блоки по 5 элементов
				/*if($icount == 0 || $icount % 5 == 0) {

					// первому даем класс active остальным notactive
					if ($icount == 0) { $boolActive = true; }
					else { $boolActive = false; }

					*/?><!--<div class="bx_catalog_tile_slide <?/* echo ($boolActive ? 'active' : 'notactive'); */?>">--><?/*
				}*/
				...
				// кастомыный костыль закрытие div class="bx_catalog_tile_slide"
				/*$icount++;					//*
				if($icount % 5 == 0) {		//*
					*/?><!--</div>--><?/*				//*
				}*/							//*
        ...
        <div class="slider_real_top_controls">
            <div class="s_prev"><span class="icon"></span></div>
            <div class="s_next"><span class="icon"></span></div>
        </div>
    ...
    <?
        ...
        // @Todo: $strContID look to \bitrix\templates\polka\components\bitrix\catalog.top\template1\slider\template.php
